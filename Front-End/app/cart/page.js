      ...
      <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8">
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <dl className="mt-0.5 space-y-px text-[12px] text-gray-600">
                      <div>
                        <dt className="inline text-[10px]">الفئة:</dt>
                        <dd className="inline">
                  ...
                  <div className="flex items-center justify-end flex-1 gap-2">
                    EGP {item?.product?.attributes?.price}
                    <button
            ...
            <h2 className="text-gray-400 text-[18px] mt-3">
              ❤️ ملحوظة: تقييمك لمنتجاتنا يُسعدنا دائماً ، اترك لنا رأيك عند
              الاستلام
            </h2>
          </div>
        </div>
